...
<script>
    ...
    if(mode === "silver"){
        ...
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=english"><i class="fa-solid fa-language"></i>  비지니스영어과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=secretary"><i class="fa-solid fa-chart-line"></i>  스마트경영비서학과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=tour"><i class="fa-solid fa-globe"></i>  관광서비스경영학과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=china"><i class="fa-solid fa-language"></i>  비즈니스중국어학과</a></div>');
        ...
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=multi"><i class="fa-solid fa-desktop"></i>  멀티미디어디자인학과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=webtoon"><i class="fa-solid fa-pen-nib"></i>  웹툰만화학과</a></div>');
        ...
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=city"><i class="fa-solid fa-road-bridge"></i>  도시기반시설공학과</a></div>'); //아이콘 교량 도로
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=inner"><i class="fa-solid fa-ruler-combined"></i>  실내건축과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=disaster"><i class="fa-solid fa-building-shield"></i>  스마트건설방재학과</a></div>');
    }else if(mode === "person"){
        ...
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=human"><i class="fa-solid fa-person"></i>  사회복지학과</a></div>');
        ...
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=kinggodgod"><i class="fa-solid fa-wrench"></i>  기계공학과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=car"><i class="fa-solid fa-car"></i>  기계자동차공학과</a></div>');
        ...
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=digital"><i class="fa-solid fa-highlighter"></i>  디지털산업디자인학과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=influencer"><i class="fa-solid fa-podcast"></i>  방송연예과</a></div>');
        $('#nav').append('<div class="nav_div"><a href="/instorage/board/list?type=beauty"><i class="fa-solid fa-broom-ball"></i>  방송헤어미용예술학과</a></div>');
